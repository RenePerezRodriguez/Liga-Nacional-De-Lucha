...
export function SocialFab() {
    ...
    const socialLinks = [
        {
            name: "WhatsApp",
            href: "https://wa.me/59170000000?text=Hola,%20quiero%20información%20sobre%20Lucha%20Libre%20Bolivia",
            icon: MessageCircle,
            color: "bg-green-600 hover:bg-green-500",
        },
        {
            name: "Facebook",
            href: "https://www.facebook.com/profile.php?id=61559310413691",
            icon: Facebook,
            color: "bg-blue-600 hover:bg-blue-500",
        },
        {
            name: "YouTube",
            href: "https://www.youtube.com/@LigaNacionalDeLucha",
            icon: () => (
        ...
        {
            name: "TikTok",
            href: "https://www.tiktok.com/@liganacionalde.lucha",
            icon: () => (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
